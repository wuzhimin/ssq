...
table tbody tr td {
  ...
  <body>
    <center>
			...
			<s:form action="/pcb/query" theme="simple">
				<table>
					<thead>
						<tr>
							<th>
					...
					<tbody>
						<s:iterator value="listAlarm" status="u">
							<tr>
								<td>
								...
								<td>
									<s:property value="wid" />
								</td>
								<td>
									<s:property value="gaptime" />
								</td>
								<td>
									<s:property value="wcontent" />
								</td>
								<td>
