 ...
 *
 */
public class FourContinueFilter implements Filter {
	...
	public boolean doFilter(String str) {
		...
		boolean b1 =   (a[1] == a[0] + 1) && (a[2] == a[1] + 1) && (a[3] == a[2] + 1);
		boolean b2 =   (a[2] == a[1] + 1) && (a[3] == a[2] + 1) && (a[4] == a[3] + 1);
		boolean b3 =   (a[3] == a[2] + 1) && (a[4] == a[3] + 1) && (a[5] == a[4] + 1);
