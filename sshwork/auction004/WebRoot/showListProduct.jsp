...
<table width="571" height="81" border="1" >
  ...
  <tr align="center">
    ...
    <td><s:if test="#session.users==null"><a href="loginUsers.jsp">竞拍</a></s:if>
    <s:if test="#session.users!=null"><a href="showProductDesc?product.pid=<s:property value="pid"/>">竞拍</a></s:if>
    </td>  
